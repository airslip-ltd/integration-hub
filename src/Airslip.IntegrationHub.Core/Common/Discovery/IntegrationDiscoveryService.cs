...
public class IntegrationDiscoveryService : IIntegrationDiscoveryService
{
    ...
    public IntegrationDiscoveryService(
        ...
        IOptions<SettingCollection<ProviderSetting>> providerSetting, 
    ...
    public IntegrationDetails GetIntegrationDetails(string provider, string integration)
    {
