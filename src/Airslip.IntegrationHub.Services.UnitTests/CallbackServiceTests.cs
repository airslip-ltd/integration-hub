...
namespace Airslip.IntegrationHub.Services.UnitTests
{
    public class CallbackServiceTests
    {
        ...
        // [InlineData(
        //     "_3dcart",
        //     "?client_id=app-id&redirect_uri=https://dev-oauth.airslip.com/oauth/v1/auth/callback/_3DCart&response_type=code&shop=airslip-development",
        //     "state",
        //     "https://apirest.3dcart.com/oauth/authorize?client_id=app-id&redirect_uri=callback-uri&response_type=code&store_url=https://airslip-development.3dcartstores.com")]
         ...
         //     "state",
         //     "https://airslip-development.myshopify.com/admin/oauth/authorize?client_id=client-id&scope=read_orders,read_products,read_inventory&redirect_uri=https://dev-oauth.airslip.com/oauth/v1/auth/callback/Shopify&grant_options[]=per-user")]
         // [InlineData("vend",
         //     "",
         //     "state",
         //     "https://secure.vendhq.com/connect?response_type=code&client_id=SrSLyYuwnffktH2oGJEJbQTiCXzkHgoL&redirect_uri=https://dev-oauth.airslip.com/oauth/v1/auth/callback/Vend")]
         // [InlineData("squarespace",
         //     "?shop=airslip-development",
         //     "state",
         //     "https://airslip-development.squarespace.com/api/1/login/oauth/provider/authorize?client_id=client-id&scope=website.orders.read,website.transactions.read,website.inventory.read,website.products.read&redirect_uri=https://dev-oauth.airslip.com/oauth/v1/auth/callback/Squarespace&access_type=offline")]
        ...
        //      "https://dev-oauth.airslip.com/api2cart/v1",
        ...
        //
        //      providerDetails.Provider.Should().Be(Enum.Parse<PosProviders>(provider));
        //      providerDetails.DestinationBaseUri.Should().Be("https://dev-oauth.airslip.com/api2cart/v1");
